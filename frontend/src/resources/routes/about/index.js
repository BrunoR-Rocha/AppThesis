                ...
                <div className="w-11/12 mx-auto md:w-full flex flex-col md:flex-row md:flex-wrap justify-center items-center gap-10">
                    <TeamCard>
                        <TeamMemberInfo>
                            ...
                            <p className="mx-5">Computer Science Masters Student and Full-Stack Developer</p>
                            <TeamMemberSocial
                                href={"#"}
                                target="_blank"
                    ...
                    <TeamCard>
                        <TeamMemberInfo>
                            ...
                            <p className="mx-5">Project Coordinator and Associate Professor at the University of Madeira</p>
                            <TeamMemberSocial
                                href={"#"}
                                target="_blank"
                                rel="noopener noreferrer"
                    ...
                    <TeamCard>
                        <TeamMemberInfo>
                            ...
                            <p className="mx-5">Project Co-Coordinator and ITI/Larsys Investigator</p>
                            <TeamMemberSocial
                                href={"#"}
                                target="_blank"
                                rel="noopener noreferrer"
                        ...
                        {loading ? (
                            ...
                            return (
                                ...
                                >
                                    <FaqItem 
                                    expanded={expanded === 'faq_'+index}
                                    expandIcon={expanded === 'faq_'+index ? <RemoveIcon sx={{color: "#6078DF"}} /> : <AddIcon sx={{color: "#6078DF"}} />} 
                                    sx={{ 
                                        paddingBlock: "10px", 
                                        borderRadius: expanded === 'faq_'+index ? "20px 20px 0 0" : "20px", 
                                        border: "2px solid #1A184C", 
                                        borderBottom: expanded === 'faq_'+index ? "none" : "2px solid #1A184C",
                                        background: expanded === 'faq_'+index ? "rgba(96, 120, 223, 0.5)" : "rgba(26, 24, 76, 0.25)",
                                    }}>
                                        <p>{faq.title}</p>
                                    </FaqItem>
                                    <FaqItemDescription sx={{borderRight: "2px solid #1A184C", borderLeft: "2px solid #1A184C", borderTop: "none"}}>
                                        {faq.body}
                                    </FaqItemDescription>
                                </Accordion>
                            );
