                ...
                <div className="flex-1 flex justify-center items-center bg-white h-full">
                    <div className="w-full lg:max-w-screen-md flex flex-col gap-8 lg:gap-20 p-10 lg:p-20">
                        ...
                        <div className="flex flex-col gap-5">
                            <p className="uppercase text-[#44456A] font-medium text-sm">Welcome Back</p>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-full gap-4">
                                <AuthInput>
                                    ...
                                    <input id="login_email" type="text" placeholder="Email" {...register("email", {required: true, pattern: /^\S+@\S+$/i})} />
                                </AuthInput>
                                <AuthInput>
                                    <label htmlFor="login_password">Password</label>
                                    <input id="login_password"type="password" placeholder="Password" {...register("password", {required: true})} />
                                </AuthInput>
                            ...
                            <p className="text-center font-medium text-md">Are you a Newbie? <Link to={'/register'} className="uppercase text-[#6078DF] underline">Get Started</Link></p>
                        </div>
                    </div>
                </div>
            </AuthArea>
